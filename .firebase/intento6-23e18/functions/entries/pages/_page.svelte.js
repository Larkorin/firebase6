...
const Page = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  $$result.css.add(css);
  return `${$$result.head += `<!-- HEAD_svelte-17kch3i_START -->${$$result.title = `<title>Home</title>`, ""}<meta name="description" content="Svelte demo appssds"><!-- HEAD_svelte-17kch3i_END -->`, ""} <section class="s-y_bCXRrkrYfP"><h1 class="s-y_bCXRrkrYfP"><span class="welcome s-y_bCXRrkrYfP"><picture><source${add_attribute("srcset", welcome, 0)} type="image/webp"> <img${add_attribute("src", welcome_fallback, 0)} alt="Welcome" class="s-y_bCXRrkrYfP"></picture></span>
